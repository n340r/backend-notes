...
### [Интро по system design.](https://www.youtube.com/watch?v=popkBBjbAv8)

- Много **ресурсов**, **сайтов**, **каналов** упомянает там в качестве советов - круто.
- Помотреть на X2, новичкам полезно
